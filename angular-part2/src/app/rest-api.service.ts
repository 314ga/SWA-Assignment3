...
export class RestAPIService {
  ...
  **/
  postHistoricData(type: string, value: number, unit: string, dateTime: Date, place: string, extras: string): Observable<any>
  {
    const httpOptions = {
    ...
    return this.http.post<any>(this.configUrl + "data", { value: value, type: type, unit: unit,
    time:dateTime, place:place}, httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  };
